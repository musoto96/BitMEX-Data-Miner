...
function makeRequest(verb, endpoint, data = {}, testnet=true) {
...
async function main(method, endpoint, symbol, data={}) {
  try {
...
main(method='GET', endpoint='trade/bucketed', symbol='XBTUSD', data={binSize: "1h", count: 2});
